...
import grootslang from './grootslang.png';
import kallePaulTheDominator from './kalle_paul_the_dominator.png';
import karooMermaid from './karoo_mermaid.png';
import laMonstrenca from './la_monstrenca.png';
import mamlambo from './mamlambo.png';
